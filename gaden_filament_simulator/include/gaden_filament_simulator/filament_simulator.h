#ifndef GADEN_FILAMENT_SIMULATOR_FILAMENT_SIMULATOR_H_INCLUDED
#define GADEN_FILAMENT_SIMULATOR_FILAMENT_SIMULATOR_H_INCLUDED
...
private:
    // simulation time
    double t_sim; // [s] current time of the simulation
    double time_step; // [s] time increment between gas snapshots
};

} // namespace gaden

#endif // GADEN_FILAMENT_SIMULATOR_FILAMENT_SIMULATOR_H_INCLUDED
